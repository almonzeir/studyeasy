...
export default function ChatbotPage() {
  return (
    <div className="flex flex-1 flex-col items-center px-4 pt-2 pb-2 sm:px-6 lg:px-8 bg-gradient-to-br from-background via-secondary/10 to-background"> {/* Changed height to flex-1 */}
