    ...
    <div className="flex flex-col">
      ...
      <section className="relative py-20 md:py-32 bg-gradient-to-br from-primary to-primary/80 text-primary-foreground">
        ...
        <div className="container relative z-10 text-center">
          <h1 className="mb-6 font-headline text-5xl font-bold md:text-6xl lg:text-7xl animate-fade-in-down">
            أهلاً بك في <span className="text-accent">دليلك في ماليزيا</span>
          </h1>
          <p className="mb-8 text-lg md:text-xl lg:text-2xl text-primary-foreground/90 animate-fade-in-up">
